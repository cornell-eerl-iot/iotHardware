...
//rasp 
{ 0x20, 0xFB, 0x00, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 }; //test board 1
...
//rasp 
{ 0x93, 0x2B, 0xF5, 0x93, 0x9B, 0xAF, 0x60, 0x00 }; //test board 1
...
//rasp 
{ 0x21, 0xC8, 0x39, 0x66, 0x22, 0xEE, 0xF3, 0xDA, 0xAE, 0x2A, 0x92, 0x89, 0x82, 0x51, 0xD8, 0x29 }; //test board 1
...
void loop() {
    os_runloop_once();
    uint32_t tim = millis();
    mydata[1] = (tim>>24) & 0xFF;
    mydata[2] = (tim>>16) & 0xFF;
    mydata[3] = (tim>>8 ) & 0xFF;
    mydata[4] = tim & 0xFF;
}