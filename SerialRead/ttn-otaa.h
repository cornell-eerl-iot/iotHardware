...
static const u1_t PROGMEM DEVEUI[8]= { 0xC5, 0x2A, 0xEC, 0xE4, 0xE0, 0xF1, 0xF5, 0x00 };
void os_getDevEui (u1_t* buf) { memcpy_P(buf, DEVEUI, 8);}
//lsb
static const u1_t PROGMEM APPKEY[16] = 
{ 0xD3, 0x1A, 0x7E, 0x51, 0x44, 0x10, 0xB8, 0xE5, 0xFF, 0xAF, 0xD2, 0xD0, 0xC9, 0x7C, 0x5E, 0x71 };
