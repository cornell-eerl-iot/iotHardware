...
static const u1_t PROGMEM DEVEUI[8]= { 0xB2, 0xCE, 0xF4, 0x74, 0x6B, 0x0B, 0xBA, 0x00 };
void os_getDevEui (u1_t* buf) { memcpy_P(buf, DEVEUI, 8);}

static const u1_t PROGMEM APPKEY[16] = { 0xF1, 0xA5, 0xB0, 0xDF, 0xC5, 0x32, 0xEB, 0xBE, 0xE8, 0xB9, 0x8C, 0x13, 0x87, 0x2E, 0x71, 0xCC };
