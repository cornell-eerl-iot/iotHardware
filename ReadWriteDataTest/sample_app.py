...
header = ["Refrigerator Real","Microwave-Real","Phone charger Real",\
"Refrigerator Reactive","Microwave-Reactive","Phone charger Reactive",\
"Dishwasher-Real","Disposal-Real","Laptop Charging-Real",\
"Dishwasher-Reactive","Disposal-Reactive","Laptop Charging -Reactive"]
header = ["Time"]+header
writer.writerow(header)
